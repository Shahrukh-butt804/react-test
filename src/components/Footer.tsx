...
export default function Footer() {
  return (
    <div className="px-32  border-t border-white">

      <div className="flex flex-col md:flex-row justify-center items-center gap-10 md:gap-0 py-16 ">
        <div className="flex-1/2">
          <img className="md:hidden" src={imageUrl("logo.png")} alt="" />
          <h1 className="hidden md:block text-7xl ">Join us for an <br /> unforgettable experience</h1>
        </div>

        <div className="flex-1/2 flex flex-col items-center gap-4">
          <div className="flex flex-col gap-2">
            <p className="text-2xl">Download the Groves App</p>
      ...
      <div className="flex justify-between items-center py-7 bg-transparent">
        <div>
